<?php
/*
Plugin Name: WP Hide Updates Notifications and Warnings
Description: The plugin allows you to disable/hide plugin notifications. Visit our website for information www.milestonemedia.ie/wp-hide-updates-notifications-and-warnings/
Version: 1.0
Plugin URI: http://www.milestonemedia.ie/wp-hide-updates-notifications-and-warnings/
Author: Milestone Media
Author URI: http://www.milestonemedia.ie/
TextDomain: wphpuw
*/
...
class WP_HPUW
{
	...
	public function settingsForm()
	{
		...
		$page .= '<a href="https://www.milestonemedia.ie" class="mlw-logo"><img src="'.plugin_dir_url(__FILE__).'images/logo.png" style="width:350px;"></a>';
		$page .= '<p class="mlw-copyright">Developed by&nbsp;<a href="https://www.milestonemedia.ie" target="_blank">Milestone Media</a></p>';
		...
		$page .= '<div class="mlw-hide-warning"><table class="wphpuw_plugins_table"><tr><td><h4>'.__("OPTION_WARNINGS_HEADING","wphpuw").'</div></h4></td><td><div class="onoffswitch class-for-float"><input type="checkbox" name="options[notifications]" value="1"'.(($this->options["notifications"]==1)?' checked="checked"':'').' id="wphpuw_notifications" class="onoffswitch-checkbox" /><label class="onoffswitch-label" for="wphpuw_notifications"></label></td></tr></table></div>';
		$page .= '</div>';
