<script type="text/javascript">
	...
	<div class="wrap">
		<h3><?php _e("OPTION_UPDATES_HEADING","wphpuw");?>
		<div class="onoffswitch">
			<input type="checkbox" name="options[updates][]" id="active-all"  class="onoffswitch-checkbox check-box-all" value="<?php echo esc_attr($plugin_file);?>" <?php echo ((in_array($plugin_file,$this->options["updates"])?' checked="checked"':'')); ?> />
				<label class="onoffswitch-label" for="active-all"></label>
			</div>
			</h3>
		...
		<tr>
			...
			<td><div class="onoffswitch"><input type="checkbox" name="options[updates][]" value="<?php echo esc_attr($plugin_file);?>" <?php echo ((in_array($plugin_file,$this->options["updates"])?' checked="checked"':'')); ?> id="plu_<?php echo base64_encode($plugin_file);?>"  class="onoffswitch-checkbox check-all"/>
